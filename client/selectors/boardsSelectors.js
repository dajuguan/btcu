...
export const getStarredVisibility = () =>
  !!cookie.get("starred_accordion_hidden");
...
export const getAllSpinner = state =>
  state.pages.main.all.isFetching && !!state.pages.main.all.lastUpdated;
...
export const makeGetBoard = () =>
  createDeepEqualSelector([getBoardEntity], identity);
